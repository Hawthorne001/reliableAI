...
def estimate_covariance(data, G, tol=1e-4, max_iters=10):
    X = data.copy()
    ...
    idx_var_map = {i: v for i, v in enumerate(columns)}
    var_idx_map = {v: i for i, v in enumerate(columns)}
    idxs = set(range(d))
    zero_param_directed = {}

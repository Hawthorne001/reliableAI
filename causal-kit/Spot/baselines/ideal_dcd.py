...
def ideal_dcd_test(g_path: str, verbose:bool=False):
    ...
    if verbose: print("Ideal DCD", g_path, compare_pag(est_dcd_g.get_graph_edges(), cpag.get_graph_edges()))

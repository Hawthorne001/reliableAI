...
def constrained_dcd_test(g_path: str, verbose:bool=False):
    ...
    if verbose: print("Constrained DCD", g_path, compare_pag(est_dcd_g.get_graph_edges(), cpag.get_graph_edges())) 
...
if __name__ == "__main__":
    ...
    print(constrained_dcd_test(g_p, True))